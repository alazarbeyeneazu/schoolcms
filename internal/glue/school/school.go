...
func InitRoute(
	...
	schoolRoutes := []routing.Router{
		...
		},
		{
			...
			Method:      http.MethodGet,
			Path:        "schools/phone/:phone",
			Handler:     school.GetSchoolByPhone,
			Middlewares: []gin.HandlerFunc{},
			Domain: []state.Domain{
				authDomains.System,
				authDomains.Corporate,
			...
			Path:        "schools",
			Handler:     school.UpdateSchoolStatus,
			Middlewares: []gin.HandlerFunc{},
			Domain: []state.Domain{
				authDomains.System,
				authDomains.Corporate,
		...
		},
		{
			...
			Path:        "schools",
			Handler:     school.UpdateSchoolInformation,
			Middlewares: []gin.HandlerFunc{},
			Domain: []state.Domain{
				authDomains.System,
				authDomains.Corporate,
